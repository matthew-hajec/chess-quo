defmodule ChessQuoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChessQuoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChessQuoWeb.Gettext, "errors", msg, opts)
    end
  end
