defmodule ChessQuo.Games.Embeds.Move do
  use Ecto.Schema
  ...
  ## Examples
    iex> ChessQuo.Games.Embeds.Move.build!(%{from: %{type: "pawn", color: :white, position: 12}, to: %{type: "pawn", color: :white, position: 20}})
    %ChessQuo.Games.Embeds.Move{
    ...
    iex> ChessQuo.Games.Embeds.Move.build!(%ChessQuo.Games.Embeds.Move{from: %ChessQuo.Games.Embeds.Piece{type: "pawn", color: :white, position: 12}, to: %ChessQuo.Games.Embeds.Piece{type: "pawn", color: :white, position: 20}})
    %ChessQuo.Games.Embeds.Move{
      from: %ChessQuo.Games.Embeds.Piece{type: "pawn", color: :white, position: 12},
      to: %ChessQuo.Games.Embeds.Piece{type: "pawn", color: :white, position: 20}
    }
